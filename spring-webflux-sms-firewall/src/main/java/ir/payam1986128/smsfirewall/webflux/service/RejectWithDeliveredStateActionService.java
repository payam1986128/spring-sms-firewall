...
@Service
@AllArgsConstructor
public class RejectWithDeliveredStateActionService implements ActionService {
    @Override
    public Mono<Sms> act(LimiterCondition condition, Sms sms) {
        return Mono.fromCallable(() -> {
            ...
            sms.setAction(Action.DONT_SEND_WITH_DELIVERED_STATE);
            return sms;
        });
    }
    ...
    public Action getAction() {
        return Action.DONT_SEND_WITH_DELIVERED_STATE;
    }
}
